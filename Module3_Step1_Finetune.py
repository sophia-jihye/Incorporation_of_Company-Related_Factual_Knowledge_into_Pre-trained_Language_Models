...
train_filepaths = sorted(glob(os.path.join(root_dir, 'ft_data', 'train_*.csv')))
test_filepath = os.path.join(root_dir, 'ft_data', 'test_10000.csv')

model_name_or_dirs = []
model_name_or_dirs.extend(sorted(glob(os.path.join(root_dir, 'pt_*', 'item*'))))

save_dir_format = os.path.join(root_dir, 'result_{}')
...
if __name__ == '__main__':        
    ...
    for train_filepath in train_filepaths:
        ...
        for model_name_or_dir in model_name_or_dirs:
            save_dir = save_dir_format.format(os.path.basename(os.path.dirname(model_name_or_dir)))
